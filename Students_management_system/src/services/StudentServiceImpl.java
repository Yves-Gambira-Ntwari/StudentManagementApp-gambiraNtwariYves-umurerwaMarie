...
public class StudentServiceImpl implements StudentService {
    ...
    public boolean updateStudent(Students students) {
        ...
        try (Connection conn = DatabaseConnection.getConnection();
            ...
            pstmt.setString(2, students.getLastName());
            pstmt.setString(3, students.getEmail());
            pstmt.setString(4, students.getPhone());
            pstmt.setString(5, students.getDepartment());
            pstmt.setInt(6, students.getEnrollmentYear());
            pstmt.setDouble(7, students.getGpa());
            pstmt.setInt(8, students.getStudentId());
